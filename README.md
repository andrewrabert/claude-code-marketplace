...
| Skill                  | Description                                                                                                                                                                                                                      |
|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `declaration-manifest` | Declaration manifest formats for plans. Load before writing any `Declaration Manifest` plan section — the per-surface manifest specs (Python, Rust, CLI) and the rule for embedding a manifest as a plan section.                |
