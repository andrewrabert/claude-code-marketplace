...
Details: `references/error-strategy.md` (library vs application design,
...
Details: `references/concurrency-models.md` (async models, Send/Sync
semantics, performance characteristics).

## Conventions

Declarations follow Rust naming and style convention so the surface compiles
as written: `references/conventions.md` (50 core rules),
`references/conventions-index.md` (rule index),
`references/clippy-lints.md` (lint reference).
